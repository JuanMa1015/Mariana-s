    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f5f7fb] text-slate-900 px-4">
      <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 mt-2">Crear Cuenta</h1>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ¿Ya tienes cuenta? <Link to="/login" className="font-semibold text-violet-500 hover:underline">Inicia sesión</Link>
        </p>
      </div>
    </div>
  )
